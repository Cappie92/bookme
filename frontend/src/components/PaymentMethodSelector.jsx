      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Клиент оплачивает услугу сразу после бронирования. Время на оплату: 30 минут
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-start space-x-2">
          ...
          <div className="text-sm text-blue-800">
            ...
            <ul className="list-disc list-inside space-y-1 text-xs">
              ...
              <li>При предоплате клиент получает 30 минут на оплату</li>
              <li>Если оплата не произведена вовремя, бронирование автоматически отменяется</li>
            </ul>
          </div>
        </div>
      </div>
