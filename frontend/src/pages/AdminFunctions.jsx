...
export default function AdminFunctions() {
  ...
  const [activeTab, setActiveTab] = useState('functions') // 'functions', 'subscriptions', 'subscription-plans', 'promo-codes'
        ...
        <div className="flex space-x-3">
          {activeTab === 'functions' && (
            <button
              ...
              className="flex items-center px-4 py-2 bg-[#4CAF50] text-white rounded-lg hover:bg-[#43a047]"
            >
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    className="flex-1 border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#4CAF50] font-mono"
                    placeholder="ABC123"
                    maxLength={6}
                  />
                  <button
              ...
              <div className="flex items-center">
                <input
                  ...
                  className="h-4 w-4 text-blue-600 focus:ring-[#4CAF50] border-gray-300 rounded"
                />
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <button
              ...
              className="bg-[#4CAF50] text-white px-4 py-2 rounded-md hover:bg-[#43a047] flex items-center"
            >
                      ...
                      <tr key={plan.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 text-sm text-gray-900">
                          <div className="space-y-1">
                            <div>1м: {Math.ceil(plan.price_1month || 0).toLocaleString()} ₽/мес</div>
                            <div>3м: {Math.ceil(plan.price_3months || 0).toLocaleString()} ₽/мес</div>
                            <div>6м: {Math.ceil(plan.price_6months || 0).toLocaleString()} ₽/мес</div>
                            <div>12м: {Math.ceil(plan.price_12months || 0).toLocaleString()} ₽/мес</div>
                            <div className="text-xs text-gray-500 pt-1 border-t border-gray-100 mt-1">
                              Итого: 1м = {(Math.ceil(plan.price_1month || 0) * 1).toLocaleString()} ₽; 3м = {(Math.ceil(plan.price_3months || 0) * 3).toLocaleString()} ₽; 6м = {(Math.ceil(plan.price_6months || 0) * 6).toLocaleString()} ₽; 12м = {(Math.ceil(plan.price_12months || 0) * 12).toLocaleString()} ₽
                            </div>
                          </div>
                        </td>
