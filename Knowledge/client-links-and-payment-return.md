...
The initialization response may require an external card payment or may direct the caller to free/balance application paths. Exact price split and idempotent application rules belong to [Subscriptions billing](subscriptions-billing.md) and [Robokassa contract](payments-robokassa.md).
...
- Credential and analytics privacy boundaries are tracked in [Security and privacy Debt](security-and-privacy.md).
