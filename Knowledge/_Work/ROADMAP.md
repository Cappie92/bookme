...
| 4 | Client CRM, Loyalty, Promo and Finance | P1 | Booking completion facts; billing boundaries | `in_progress` | Минимальные Domain владельцы для CRM, loyalty, promo и finance; Contracts/Debt только при реальной границе | Money-like ledgers и side effects разделены от SaaS billing и Booking lifecycle |
