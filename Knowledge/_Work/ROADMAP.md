...
| 3 | Feature flags, Entitlements and Background Jobs | P0 | Billing canon; production topology | `in_progress` | `Contracts/feature-entitlements.md`, `Architecture/background-jobs.md`, `Infrastructure/configuration.md`, optional Debt | Env/DB/client flags и пять loops имеют source-backed ownership, precedence и single-instance constraints |
