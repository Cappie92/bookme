...
- **Validity:** UNKNOWN
- **Sensitivity:** HIGH
- **Sanitized sources:** `frontend/src/components/YANDEX_API_SETUP.md`; `docker-compose.yml`; `mobile/src/services/analytics/apiKey.ts`; `backend/tests/conftest.py`; access-named tracked artifacts listed in `Knowledge/Debt/security-and-privacy.md`.
