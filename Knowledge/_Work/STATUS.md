...
- Mobile welcome pricing fallback is owned by `Knowledge/Architecture/mobile.md`; RC-010 remains **OPEN / P1** for product policy and error/parity test remediation.
...
- Intended documentation-only changes are limited to `Knowledge/Architecture/mobile.md`, `COVERAGE-MATRIX.md`, `DRIFT-QUEUE.md` and `STATUS.md`.
