...
Topology принадлежит [Production topology](../Infrastructure/production-topology.md), database/schema lifecycle — [Data and migrations](../Architecture/data-and-migrations.md), а workflow semantics — [CI/CD](ci-cd.md). Этот inventory не повторяет их детальные контракты.
...
- [Production topology](../Infrastructure/production-topology.md) — Compose/network/storage and host-unknown boundary.
- [Data and migrations](../Architecture/data-and-migrations.md) — SQLite identity, Alembic and schema lifecycle.
