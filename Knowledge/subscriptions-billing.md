...
- [subscriptions-billing-money-flows.md](subscriptions-billing-money-flows.md) — сценарии
- [subscriptions-billing-invariants.md](subscriptions-billing-invariants.md) — инварианты
- [payments-robokassa.md](payments-robokassa.md) — контракт Robokassa
- [feature-entitlements.md](feature-entitlements.md) — effective subscription и capability enforcement
- [background-jobs.md](background-jobs.md) — lifecycle daily charge и cleanup jobs
- [subscriptions-billing-debt.md](subscriptions-billing-debt.md) — ограничения и долг
...
Подробные сценарии — в [subscriptions-billing-money-flows.md](subscriptions-billing-money-flows.md); контракт карты — в [payments-robokassa.md](payments-robokassa.md).
...
Различия verify success: [subscriptions-billing-money-flows.md](subscriptions-billing-money-flows.md#web--mobile-verify-drift-сводка).
...
7. Clients: `subscriptionPaymentApply.js` vs `subscriptionPayment.ts` + [verify drift](subscriptions-billing-money-flows.md#web--mobile-verify-drift-сводка).
