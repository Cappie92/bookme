...
`LoyaltyTransaction` оплачивает услугу клиента у мастера. `SubscriptionPointsLedger`, создаваемый promo rewards и расходуемый на SaaS-подписку, принадлежит [Promo](promo.md) и [Subscriptions Billing](subscriptions-billing/README.md). Балансы не суммируются и не конвертируются друг в друга repository runtime.

Подтверждённые semantic/idempotency gaps описаны в [Debt](../Debt/client-crm-loyalty-promo-finance.md).
