...
Связанные topology constraints и process multiplicity принадлежат [Production topology](production-topology.md); billing-specific конкурентные failure scenarios принадлежат [Debt — subscriptions billing](subscriptions-billing-debt.md).
...
- `subscriptions-billing-debt.md` — confirmed SQLite and locking-related billing constraints.

## Related documents

- [Production topology](production-topology.md) — services, network, persistent volumes and process model.
- [Staging infrastructure](staging.md) — active production clone, applied revision and integrity state.
- [Debt — subscriptions billing](subscriptions-billing-debt.md) — billing-specific concurrency and reliability constraints.
