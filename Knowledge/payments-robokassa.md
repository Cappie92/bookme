...
См. домен: [subscriptions-billing.md](subscriptions-billing.md), [money-flows.md](subscriptions-billing-money-flows.md).
...
Канон успеха на backend: `paid` + `applied`. Различие клиентского verify — в [money-flows.md](subscriptions-billing-money-flows.md#web--mobile-verify-drift-сводка).
