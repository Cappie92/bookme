...
**Sources:** `backend/tests/test_bookings.py`; [Scheduling canon](scheduling.md); [Backend/API Debt](backend-api.md); [Testing/delivery Debt](testing-delivery-onboarding.md).
