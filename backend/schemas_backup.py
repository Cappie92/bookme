...
class Booking(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    edit_requests: List[BookingEditRequest] = []
...
class ClientRestrictionBase(BaseModel):
    ...
    restriction_type: str = Field(..., regex="^(blacklist|advance_payment_only)$", description="Тип ограничения")
...
class ClientRestrictionUpdate(BaseModel):
    restriction_type: Optional[str] = Field(None, regex="^(blacklist|advance_payment_only)$")
...
class ExpenseBase(BaseModel):
    ...
    recurring_frequency: Optional[str] = Field(None, regex="^(monthly|quarterly|yearly)$", description="Частота")
...
class ExpenseUpdate(BaseModel):
    ...
    recurring_frequency: Optional[str] = Field(None, regex="^(monthly|quarterly|yearly)$")
