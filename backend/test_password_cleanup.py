...
def test_password_cleanup():
    base_url = "http://localhost:8000"
    
    print("=== ТЕСТ УДАЛЕНИЯ ПОЛЬЗОВАТЕЛЕЙ БЕЗ ПАРОЛЯ ===")
    
    # 1. Создаем бронирование для нового пользователя
    print("\n1. Создаем бронирование для нового пользователя +77777777777")
    ...
    booking_data = {
        ...
        "end_time": "2025-07-24T12:00:00",
        "notes": "Тестовое бронирование для проверки удаления"
    }
    
    params = {"client_phone": "+77777777777"}
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # 2. Проверяем, что пользователь и бронирование созданы
            print("\n2. Проверяем создание пользователя и бронирования")
            ...
            if user:
                ...
                # 3. Симулируем отмену регистрации (удаление аккаунта)
                print("\n3. Симулируем отмену регистрации (удаление аккаунта)")
                ...
                if delete_response.status_code == 200:
                    ...
                    user_after = db.query(User).filter(User.phone == '+77777777777').first()
                    if user_after:
