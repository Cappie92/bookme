#!/usr/bin/env python3
"""
Скрипт для наполнения системы тестовыми данными
Создает клиентов, мастеров, салоны, услуги и бронирования
"""
...
def create_test_data():
    ...
    try:
        print("🌱 Создание тестовой системы...")
        ...
        print("\n🎉 Тестовая система успешно создана!")
        print("\n📊 Статистика:")
