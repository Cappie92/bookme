...
PLUSOFON_STUB_CALL_ID = "stub-plusofon-0001"
...
class PlusofonService:
    ...
    def __init__(self):
        ...
        self.access_token = s.PLUSOFON_ACCESS_TOKEN
        self.base_url = 'https://restapi.plusofon.ru'
        self.client = httpx.AsyncClient(timeout=30.0)
        self._stub_mode = s.plusofon_stub
    ...
    async def initiate_call(self, phone: str, code: str) -> Dict[str, Any]:
        ...
        """
        if self._stub_mode:
            return {"success": True, "call_id": PLUSOFON_STUB_CALL_ID, "message": "Stub: звонок симулирован"}
    ...
    async def check_call_status(self, call_id: str) -> Dict[str, Any]:
        ...
        """
        if self._stub_mode:
            return {"success": True, "verified": call_id == PLUSOFON_STUB_CALL_ID}
        if not self.access_token:
            raise ValueError("PLUSOFON_ACCESS_TOKEN не настроен")
