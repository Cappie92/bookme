...
# Stub mode: ZVONOK_MODE=stub — без реальных звонков; call_id и digits фиксированы для тестов
ZVONOK_STUB_CALL_ID = "stub-call-0001"
ZVONOK_STUB_DIGITS = "1234"
    ...
    def send_verification_call(self, phone_number: str) -> Dict[str, Any]:
        ...
        try:
            if self._stub_mode:
                ...
                logger.info(f"[ZVONOK_STUB] send_verification_call phone={clean_phone} -> call_id={ZVONOK_STUB_CALL_ID}, digits={ZVONOK_STUB_DIGITS}")
                return {
                    "success": True,
