    ...
    return (
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        >
          ...
          <TouchableOpacity style={styles.backButton} onPress={() => safeBack(BOOKINGS_LIST_PATH)}>
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>ID бронирования:</Text>
