...
export default function SettingsScreen() {
  ...
  const handleConfirmDelete = async () => {
    ...
    Alert.alert(
      'Удалить аккаунт?',
      'Аккаунт будет необратимо удалён. Персональные данные будут удалены или обезличены, доступ будет закрыт. История записей может сохраняться обезличенно; отдельные финансовые сведения — в случаях, предусмотренных законом. Это действие нельзя отменить.',
      [
        {
          text: 'Отмена',
          style: 'cancel',
    ...
    <ScreenContainer scrollable>
      ...
      <SettingsSection title="Опасная зона">
        <SettingsRow
          ...
          description="Необратимая деактивация аккаунта и обезличивание персональных данных"
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.inputGroup}>
              ...
              <PasswordInput
                ...
                accessibilityLabel="Пароль для удаления аккаунта"
